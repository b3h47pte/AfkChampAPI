...
CREATE TABLE `match_stats` (
  `matchstatsid` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `timestamp` datetime NOT NULL,
  `parentmatchid` bigint(20) unsigned NOT NULL,
  PRIMARY KEY (`matchstatsid`,`parentmatchid`),
  KEY `match_stats_parentmatchid_idx` (`parentmatchid`),
  CONSTRAINT `match_stats_parentmatchid` FOREIGN KEY (`parentmatchid`) REFERENCES `rocketelo`.`matches` (`matchid`) ON DELETE CASCADE ON UPDATE CASCADE
